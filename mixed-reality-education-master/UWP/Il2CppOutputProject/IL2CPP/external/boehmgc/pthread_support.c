...
#   endif
    ...
    result -> id = id;
#   if defined(PLATFORM_ANDROID) || defined(PLATFORM_NOVA)
...
#         elif defined(PLATFORM_ANDROID) || defined(PLATFORM_NOVA)
            me -> kernel_id = gettid();
#         endif
...
# define GC_get_nprocs() pthread_num_processors_np()
      ...
      || defined(PLATFORM_ANDROID) || defined(PLATFORM_NOVA) || defined(NACL)
